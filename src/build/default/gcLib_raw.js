...
async function gcLibModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('gcLib_raw.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('gcLib_raw.wasm', import.meta.url).href;
...
var ASM_CONSTS = {
 ...
 144041: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 144091: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 144230: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
...
var _gc_GetRandomNumber = Module['_gc_GetRandomNumber'] = makeInvalidEarlyAccess('_gc_GetRandomNumber');
var _gc_GetFrameTime = Module['_gc_GetFrameTime'] = makeInvalidEarlyAccess('_gc_GetFrameTime');
var _gc_InitWindow = Module['_gc_InitWindow'] = makeInvalidEarlyAccess('_gc_InitWindow');
var _gc_WindowShouldClose = Module['_gc_WindowShouldClose'] = makeInvalidEarlyAccess('_gc_WindowShouldClose');
var _gc_CloseWindow = Module['_gc_CloseWindow'] = makeInvalidEarlyAccess('_gc_CloseWindow');
var _gc_InitAudioDevice = Module['_gc_InitAudioDevice'] = makeInvalidEarlyAccess('_gc_InitAudioDevice');
var _gc_CloseAudioDevice = Module['_gc_CloseAudioDevice'] = makeInvalidEarlyAccess('_gc_CloseAudioDevice');
var _gc_BeginDrawing = Module['_gc_BeginDrawing'] = makeInvalidEarlyAccess('_gc_BeginDrawing');
var _gc_EndDrawing = Module['_gc_EndDrawing'] = makeInvalidEarlyAccess('_gc_EndDrawing');
var _gc_IsKeyPressed = Module['_gc_IsKeyPressed'] = makeInvalidEarlyAccess('_gc_IsKeyPressed');
var _gc_IsKeyReleased = Module['_gc_IsKeyReleased'] = makeInvalidEarlyAccess('_gc_IsKeyReleased');
var _gc_IsKeyUp = Module['_gc_IsKeyUp'] = makeInvalidEarlyAccess('_gc_IsKeyUp');
var _gc_IsKeyDown = Module['_gc_IsKeyDown'] = makeInvalidEarlyAccess('_gc_IsKeyDown');
var _gc_IsMouseButtonPressed = Module['_gc_IsMouseButtonPressed'] = makeInvalidEarlyAccess('_gc_IsMouseButtonPressed');
var _gc_IsMouseButtonReleased = Module['_gc_IsMouseButtonReleased'] = makeInvalidEarlyAccess('_gc_IsMouseButtonReleased');
var _gc_IsMouseButtonUp = Module['_gc_IsMouseButtonUp'] = makeInvalidEarlyAccess('_gc_IsMouseButtonUp');
var _gc_IsMouseButtonDown = Module['_gc_IsMouseButtonDown'] = makeInvalidEarlyAccess('_gc_IsMouseButtonDown');
var _gc_GetMousePositionX = Module['_gc_GetMousePositionX'] = makeInvalidEarlyAccess('_gc_GetMousePositionX');
var _gc_GetMousePositionY = Module['_gc_GetMousePositionY'] = makeInvalidEarlyAccess('_gc_GetMousePositionY');
var _gc_SetMousePosition = Module['_gc_SetMousePosition'] = makeInvalidEarlyAccess('_gc_SetMousePosition');
var _gc_ShowCursor = Module['_gc_ShowCursor'] = makeInvalidEarlyAccess('_gc_ShowCursor');
var _gc_HideCursor = Module['_gc_HideCursor'] = makeInvalidEarlyAccess('_gc_HideCursor');
var _gc_IsCursorHidden = Module['_gc_IsCursorHidden'] = makeInvalidEarlyAccess('_gc_IsCursorHidden');
var _gc_EnableCursor = Module['_gc_EnableCursor'] = makeInvalidEarlyAccess('_gc_EnableCursor');
var _gc_DisableCursor = Module['_gc_DisableCursor'] = makeInvalidEarlyAccess('_gc_DisableCursor');
var _gc_IsCursorOnScreen = Module['_gc_IsCursorOnScreen'] = makeInvalidEarlyAccess('_gc_IsCursorOnScreen');
var _gc_CreateCamera = Module['_gc_CreateCamera'] = makeInvalidEarlyAccess('_gc_CreateCamera');
var _malloc = makeInvalidEarlyAccess('_malloc');
var _gc_UnloadCamera = Module['_gc_UnloadCamera'] = makeInvalidEarlyAccess('_gc_UnloadCamera');
var _free = makeInvalidEarlyAccess('_free');
var _gc_MoveCamera2DX = Module['_gc_MoveCamera2DX'] = makeInvalidEarlyAccess('_gc_MoveCamera2DX');
var _gc_MoveCamera2DY = Module['_gc_MoveCamera2DY'] = makeInvalidEarlyAccess('_gc_MoveCamera2DY');
var _gc_BeginMode2D = Module['_gc_BeginMode2D'] = makeInvalidEarlyAccess('_gc_BeginMode2D');
var _gc_EndMode2D = Module['_gc_EndMode2D'] = makeInvalidEarlyAccess('_gc_EndMode2D');
var _gc_LoadSound = Module['_gc_LoadSound'] = makeInvalidEarlyAccess('_gc_LoadSound');
var _gc_UnloadSound = Module['_gc_UnloadSound'] = makeInvalidEarlyAccess('_gc_UnloadSound');
var _gc_PlaySound = Module['_gc_PlaySound'] = makeInvalidEarlyAccess('_gc_PlaySound');
var _gc_IsSoundPlaying = Module['_gc_IsSoundPlaying'] = makeInvalidEarlyAccess('_gc_IsSoundPlaying');
var _gc_SetSoundVolume = Module['_gc_SetSoundVolume'] = makeInvalidEarlyAccess('_gc_SetSoundVolume');
var _gc_SetSoundPitch = Module['_gc_SetSoundPitch'] = makeInvalidEarlyAccess('_gc_SetSoundPitch');
var _gc_LoadMusic = Module['_gc_LoadMusic'] = makeInvalidEarlyAccess('_gc_LoadMusic');
var _gc_UnloadMusic = Module['_gc_UnloadMusic'] = makeInvalidEarlyAccess('_gc_UnloadMusic');
var _gc_PlayMusic = Module['_gc_PlayMusic'] = makeInvalidEarlyAccess('_gc_PlayMusic');
var _gc_UpdateMusic = Module['_gc_UpdateMusic'] = makeInvalidEarlyAccess('_gc_UpdateMusic');
var _gc_SetMusicPitch = Module['_gc_SetMusicPitch'] = makeInvalidEarlyAccess('_gc_SetMusicPitch');
var _gc_SetMusicVolume = Module['_gc_SetMusicVolume'] = makeInvalidEarlyAccess('_gc_SetMusicVolume');
var _gc_LoadFont = Module['_gc_LoadFont'] = makeInvalidEarlyAccess('_gc_LoadFont');
var _gc_UnloadFont = Module['_gc_UnloadFont'] = makeInvalidEarlyAccess('_gc_UnloadFont');
var _gc_FontSizeX = Module['_gc_FontSizeX'] = makeInvalidEarlyAccess('_gc_FontSizeX');
var _gc_FontSizeY = Module['_gc_FontSizeY'] = makeInvalidEarlyAccess('_gc_FontSizeY');
var _gc_LoadTexture = Module['_gc_LoadTexture'] = makeInvalidEarlyAccess('_gc_LoadTexture');
var _gc_UnloadTexture = Module['_gc_UnloadTexture'] = makeInvalidEarlyAccess('_gc_UnloadTexture');
var _gc_GetTextureWidth = Module['_gc_GetTextureWidth'] = makeInvalidEarlyAccess('_gc_GetTextureWidth');
var _gc_GetTextureHeight = Module['_gc_GetTextureHeight'] = makeInvalidEarlyAccess('_gc_GetTextureHeight');
var _gc_ChangeTextureWidth = Module['_gc_ChangeTextureWidth'] = makeInvalidEarlyAccess('_gc_ChangeTextureWidth');
var _gc_ChangeTextureHeight = Module['_gc_ChangeTextureHeight'] = makeInvalidEarlyAccess('_gc_ChangeTextureHeight');
var _gc_DisableTextureFilter = Module['_gc_DisableTextureFilter'] = makeInvalidEarlyAccess('_gc_DisableTextureFilter');
var _gc_SetTargetFPS = Module['_gc_SetTargetFPS'] = makeInvalidEarlyAccess('_gc_SetTargetFPS');
var _gc_ClearBackground = Module['_gc_ClearBackground'] = makeInvalidEarlyAccess('_gc_ClearBackground');
var _gc_SetConfigFlags = Module['_gc_SetConfigFlags'] = makeInvalidEarlyAccess('_gc_SetConfigFlags');
var _gc_DrawFPS = Module['_gc_DrawFPS'] = makeInvalidEarlyAccess('_gc_DrawFPS');
var _gc_DrawText = Module['_gc_DrawText'] = makeInvalidEarlyAccess('_gc_DrawText');
var _gc_DrawTextEx = Module['_gc_DrawTextEx'] = makeInvalidEarlyAccess('_gc_DrawTextEx');
var _gc_DrawRectangleRec = Module['_gc_DrawRectangleRec'] = makeInvalidEarlyAccess('_gc_DrawRectangleRec');
var _gc_DrawRectangleRounded = Module['_gc_DrawRectangleRounded'] = makeInvalidEarlyAccess('_gc_DrawRectangleRounded');
var _gc_DrawRectanglePro = Module['_gc_DrawRectanglePro'] = makeInvalidEarlyAccess('_gc_DrawRectanglePro');
var _gc_DrawRectangleLines = Module['_gc_DrawRectangleLines'] = makeInvalidEarlyAccess('_gc_DrawRectangleLines');
var _gc_DrawRectangleLinesEx = Module['_gc_DrawRectangleLinesEx'] = makeInvalidEarlyAccess('_gc_DrawRectangleLinesEx');
var _gc_DrawRectangleRoundedLines = Module['_gc_DrawRectangleRoundedLines'] = makeInvalidEarlyAccess('_gc_DrawRectangleRoundedLines');
var _gc_DrawRectangleRoundedLinesEx = Module['_gc_DrawRectangleRoundedLinesEx'] = makeInvalidEarlyAccess('_gc_DrawRectangleRoundedLinesEx');
var _gc_DrawTexture = Module['_gc_DrawTexture'] = makeInvalidEarlyAccess('_gc_DrawTexture');
var _gc_DrawTextureRec = Module['_gc_DrawTextureRec'] = makeInvalidEarlyAccess('_gc_DrawTextureRec');
var _gc_DrawTextureEx = Module['_gc_DrawTextureEx'] = makeInvalidEarlyAccess('_gc_DrawTextureEx');
var _gc_DrawTexturePro = Module['_gc_DrawTexturePro'] = makeInvalidEarlyAccess('_gc_DrawTexturePro');
var _gcFileExists = Module['_gcFileExists'] = makeInvalidEarlyAccess('_gcFileExists');
var _gc_CheckCollisionRecs = Module['_gc_CheckCollisionRecs'] = makeInvalidEarlyAccess('_gc_CheckCollisionRecs');
var _gc_CheckCollisionCircles = Module['_gc_CheckCollisionCircles'] = makeInvalidEarlyAccess('_gc_CheckCollisionCircles');
var _gc_CheckCollisionCircleRec = Module['_gc_CheckCollisionCircleRec'] = makeInvalidEarlyAccess('_gc_CheckCollisionCircleRec');
var _gc_CheckCollisionMousetoRec = Module['_gc_CheckCollisionMousetoRec'] = makeInvalidEarlyAccess('_gc_CheckCollisionMousetoRec');
